...
router.post('/create-case/01-register-case', function(req, res) {
    // var errors = []
    ...
    // if (errors.length === 0) {
        ...
        console.log("Register case page submitted")

        res.redirect('/version12/create-case/02-area')
    // }
    // else {
    //     res.render('version12/create-case/01-register-case', { 
    //         errors: errors
    //     })
    // }
})
...
// Area page
router.post('/create-case/02-area', function(req, res) {
    req.session.data.area = req.body['docType-Area']
    res.redirect('/version12/create-case/02-case-details')
})

// Case details page
router.post('/create-case/02-case-details', function(req, res) {
...
//    req.session.data.area = req.body['docType-Area']
    ...
    if (req.session.data.suspectDetailsYesNo === 'Yes') {
        res.redirect('/version12/create-case/03-add-suspect')
    }
    else {
        res.redirect('/version12/create-case/05-complexity') 
    }    
})


// First hearing details
router.post('/create-case/02-first-hearing-details', function(req, res) {
    req.session.data.firstHearingDetailsYesNo = req.body['first-hearing-details']
...
// ************************************************** Suspects **************************************************
// Add suspects
router.post('/create-case/03-add-suspect', function(req, res) {
    ...
    if (req.body['suspect-type'] == 'Person') {
        ...
        console.log("Suspect fist name:",req.session.data.suspectFirstName[count])
    }           
    else {
    ...
    if (req.session.data.suspectDOB[id] != undefined) {
        res.redirect('/version12/create-case/03-suspect-details-dob')
    }
    else if (req.session.data.suspectGender[id] != undefined ) {
        res.redirect('/version12/create-case/03-suspect-details-gender')
    }
    else if (req.session.data.suspectDisability[id] != undefined ) {
        res.redirect('/version12/create-case/03-suspect-details-disability')
    }
    else if (req.session.data.suspectReligion[id] != undefined ) {
        res.redirect('/version12/create-case/03-suspect-details-religion')
    }
    else if (req.session.data.suspectEthnicity[id] != undefined ) {
        res.redirect('/version12/create-case/03-suspect-details-ethnicity')
    }
    else if (req.session.data.suspectAlias[id] != undefined ) {
        res.redirect('/version12/create-case/03-suspect-details-add-alias')
    }
    else if (req.session.data.suspectSDO[id] != undefined ) {
        res.redirect('/version12/create-case/03-suspect-details-sdo')
    }
    else if (req.session.data.suspectArrestSummons[id] != undefined ) {
        res.redirect('/version12/create-case/03-suspect-details-arrest-summons')
    }
    else if (req.session.data.suspectOffenderType[id] != undefined ) {
        res.redirect('/version12/create-case/03-suspect-details-offender-type')
    }
    else {
        res.redirect('/version12/create-case/03B-suspect-summary')
    }
...
router.post('/create-case/03-suspect-details-dob', function(req, res) {
...
router.post('/create-case/03-suspect-details-gender', function(req, res) {
    count = req.session.data.suspectDetailsCount
...
router.post('/create-case/03-suspect-details-disability', function(req, res) {
    count = req.session.data.suspectDetailsCount
...
router.post('/create-case/03-suspect-details-religion', function(req, res) {
    count = req.session.data.suspectDetailsCount
...
router.post('/create-case/03-suspect-details-ethnicity', function(req, res) {
    count = req.session.data.suspectDetailsCount
...
router.post('/create-case/03-suspect-details-add-alias', function(req, res) {
...
//    req.session.data.suspectDetailsCount = aliasCount
    ...
    res.redirect('/version12/create-case/03-suspect-details-alias-summary')
})

// Alias summary
router.post('/create-case/03-suspect-details-alias-summary', function(req, res) {
    count = req.session.data.suspectDetailsCount
...
// Suspect details – SDO
router.post('/create-case/03-suspect-details-sdo', function(req, res) {
    count = req.session.data.suspectDetailsCount
...
router.post('/create-case/03-suspect-details-arrest-summons', function(req, res) {
    count = req.session.data.suspectDetailsCount
...
router.post('/create-case/03-suspect-details-offender-type', function(req, res) {
    count = (req.session.data.suspectDetailsCount)
...
// Suspect summary
router.post('/create-case/03B-suspect-summary', function(req, res) {
    if (req.body['add-another'] === 'Yes') {
        res.redirect('/version12/create-case/03-add-suspect')
    }
    else {
        res.redirect('/version12/create-case/04-want-to-add-charges') 
        // res.redirect('/version12/create-case/05-complexity') 
    }    
})


router.post('/create-case/remove-suspect', function(req, res) {
    req.session.data.removeSuspectId = Number(req.body['remove-suspect-id'])
    res.redirect('/version12/create-case/03-remove-suspect') 
})


router.post('/create-case/03-remove-suspect', function(req, res) {
...
// Edit suspect
router.post('/create-case/03-edit-suspect', function(req, res) {
...
router.post('/create-case/03-edit-suspect-router', function(req, res) {
...
// Want to add charges
router.post('/create-case/04-want-to-add-charges', function(req, res) {
    ...
    if (req.session.data.wantToAddCharges === 'Yes') {
        if (req.session.data.suspectCount === 1) {
            ...
            res.redirect('/version12/create-case/04-charges-offence-search') 
        }
        else {
            res.redirect('/version12/create-case/04-add-charges-suspect')
        }
    }
    else {
        res.redirect('/version12/create-case/05-complexity') 
...
router.post('/create-case/04-add-charges-suspect', function(req, res) {
...
router.post('/create-case/add-another-charge', function(req, res) {
...
router.post('/create-case/04-charges-offence-search', function(req, res) {
    count = req.session.data.chargeCount
    ...
    res.redirect('/version12/create-case/04-charges-offence-search-results')
})

// Add charges - offence search results
router.post('/create-case/04-charges-offence-search-results', function(req, res) {
    count = req.session.data.chargeCount
    ...
    res.redirect('/version12/create-case/04-add-charges')
})


// Add charges 
router.post('/create-case/04-add-charges', function(req, res) {
    count = req.session.data.chargeCount
...
//    req.session.data.chargeComments[count] = req.body['newCharge_Comment']
    ...
    if (req.body['newCharge_Victim_YesNo'] === 'Yes') {
        res.redirect('/version12/create-case/04-add-charges-victim')
    }
    else {
        res.redirect('/version12/create-case/04-charges-summary')
    }

})

// Charges victim
router.post('/create-case/04-add-charges-victim', function(req, res) {
...
// Charges summary
router.post('/create-case/04-charges-summary', function(req, res) {
    if (req.body['add-another'] === 'Yes') {
        res.redirect('/version12/create-case/04-add-charges-suspect')
    }
    else {
        res.redirect('/version12/create-case/02-first-hearing-details') 
    }    

})

router.get('/create-case/04-charges-summary', function(req, res) {
    res.render('version12/create-case/04-charges-summary', {
        grouped: req.session.data.grouped
    });
})


router.post('/create-case/remove-charge', function(req, res) {
    ...
    res.redirect('/version12/create-case/04-remove-charge') 
})


router.post('/create-case/04-remove-charge', function(req, res) {
    if (req.body['submit-button'] == 'remove') {
...
// Complexity 
router.post('/create-case/05-complexity', function(req, res) {
...
//    }
    ...
    res.redirect('/version12/create-case/06-monitoring-codes') 
})


// Monitoring codes
router.post('/create-case/06-monitoring-codes', function(req, res) {
    res.redirect('/version12/create-case/07-cps-staff') 
})


// CPS and police staff
router.post('/create-case/07-cps-staff', function(req, res) {
    ...
    res.redirect('/version12/create-case/08-check-answers')


    // If user is LCC check if there are materials. If not, go to check your answers.
    // if (req.session.data.userType === 'LCC') {
    //     res.redirect('/version12/create-case/07-want-to-create-folders')
    // }
    // else {
    //     res.redirect('/version12/create-case/08-check-your-answers') 
    // }    
})


// Materials
router.post('/create-case/09-confirmation', function(req, res) {
...
router.get('/B-off-system-MVP/03-case-overview', function (req, res) {
    ...
    // ================================
    res.render('version12/B-off-system-MVP/03-case-overview', {
        materials,
        data,
...
router.get('/version12/manage-materials', function (req, res) {
    ...
    res.render('version12/manage-materials', {
...
router.get('/B-off-system-MVP/new-folder', function(req, res) {
    ...
    res.render('version12/B-off-system-MVP/new-folder');
});
...
router.post('/B-off-system-MVP/new-folder', function(req, res) {
    ...
    if (!newFolderName) {
        return res.render('version12/B-off-system-MVP/new-folder', {
...
router.post('/version12/case-overview', function (req, res) {
  const data = req.session.data;
  res.render('version12/B-off-system-MVP/03-case-overview', { materials: data.materials || [], data });
});
...
router.post('/B-off-system-MVP/rename-from-list', function (req, res) {
    ...
    if (!id) {
        ...
        return res.redirect('/version12/03-case-overview');
    }
    ...
    res.render('version12/B-off-system-MVP/rename', { item });
});
...
router.post('/B-off-system-MVP/rename', function (req, res) {
    ...
    if (!newName) {
        return res.render('version12/B-off-system-MVP/rename', {
        item,
        error: 'Enter a name'
        });
    }
...
//     res.render('version12/B-off-system-MVP/rename', {
//         item
//     });
// });
...
//     if (parent !== 0) {
//         return res.redirect(`/version12/03-case-overview?folder=${parent}`);
//     }
