...
router.use((req, res, next) => {
    ...
    // Alias: inside ur-feb-2026, "materials" means "materialsVersion12"
...
router.post('/B-off-system-MVP/create-case/01-register-case', function (req, res) {
    ...
    res.redirect('/ur-feb-2026/B-off-system-MVP/create-case/02-area')
    // }
    // else {
    //     res.render('ur-feb-2026/B-off-system-MVP/create-case/01-register-case', { 
    //         errors: errors
    //     })
    // }
})
...
router.post('/B-off-system-MVP/create-case/02-area', function (req, res) {
    ...
    res.redirect('/ur-feb-2026/B-off-system-MVP/create-case/02-case-details')
})
...
router.post('/B-off-system-MVP/create-case/02-case-details', function (req, res) {
    ...
    if (req.session.data.suspectDetailsYesNo === 'Yes') {
        res.redirect('/ur-feb-2026/B-off-system-MVP/create-case/03-add-suspect')
    }
    else {
        res.redirect('/ur-feb-2026/B-off-system-MVP/create-case/05-complexity')
    }
})
...
router.post('/B-off-system-MVP/create-case/03-add-suspect', function (req, res) {
    ...
    if (req.session.data.suspectDOB[id] != undefined) {
        res.redirect('/ur-feb-2026/B-off-system-MVP/create-case/03-suspect-details-dob')
    }
    else if (req.session.data.suspectGender[id] != undefined) {
        res.redirect('/ur-feb-2026/B-off-system-MVP/create-case/03-suspect-details-gender')
    }
    else if (req.session.data.suspectDisability[id] != undefined) {
        res.redirect('/ur-feb-2026/B-off-system-MVP/create-case/03-suspect-details-disability')
    }
    else if (req.session.data.suspectReligion[id] != undefined) {
        res.redirect('/ur-feb-2026/B-off-system-MVP/create-case/03-suspect-details-religion')
    }
    else if (req.session.data.suspectEthnicity[id] != undefined) {
        res.redirect('/ur-feb-2026/B-off-system-MVP/create-case/03-suspect-details-ethnicity')
    }
    else if (req.session.data.suspectAlias[id] != undefined) {
        res.redirect('/ur-feb-2026/B-off-system-MVP/create-case/03-suspect-details-add-alias')
    }
    else if (req.session.data.suspectSDO[id] != undefined) {
        res.redirect('/ur-feb-2026/B-off-system-MVP/create-case/03-suspect-details-sdo')
    }
    else if (req.session.data.suspectArrestSummons[id] != undefined) {
        res.redirect('/ur-feb-2026/B-off-system-MVP/create-case/03-suspect-details-arrest-summons')
    }
    else if (req.session.data.suspectOffenderType[id] != undefined) {
        res.redirect('/ur-feb-2026/B-off-system-MVP/create-case/03-suspect-details-offender-type')
    }
    else {
        res.redirect('/ur-feb-2026/B-off-system-MVP/create-case/03B-suspect-summary')
    }
...
router.post('/B-off-system-MVP/create-case/03-suspect-details-add-alias', function (req, res) {
    ...
    res.redirect('/ur-feb-2026/B-off-system-MVP/create-case/03-suspect-details-alias-summary')
})
...
router.post('/B-off-system-MVP/create-case/03B-suspect-summary', function (req, res) {
    if (req.body['add-another'] === 'Yes') {
        ...
        res.redirect('/ur-feb-2026/B-off-system-MVP/create-case/04-want-to-add-charges')
        // res.redirect('/ur-feb-2026/B-off-system-MVP/create-case/05-complexity') 
    }
})
...
router.post('/B-off-system-MVP/create-case/remove-suspect', function (req, res) {
    ...
    res.redirect('/ur-feb-2026/B-off-system-MVP/create-case/03-remove-suspect')
})
...
router.post('/B-off-system-MVP/create-case/04-want-to-add-charges', function (req, res) {
    ...
    if (req.session.data.wantToAddCharges === 'Yes') {
        if (req.session.data.suspectCount === 1) {
            ...
            res.redirect('/ur-feb-2026/B-off-system-MVP/create-case/04-charges-offence-search')
        }
        else {
            res.redirect('/ur-feb-2026/B-off-system-MVP/create-case/04-add-charges-suspect')
        }
    }
    else {
        res.redirect('/ur-feb-2026/B-off-system-MVP/create-case/05-complexity')
...
router.post('/B-off-system-MVP/create-case/04-charges-offence-search', function (req, res) {
    ...
    res.redirect('/ur-feb-2026/B-off-system-MVP/create-case/04-charges-offence-search-results')
})
...
router.post('/B-off-system-MVP/create-case/04-charges-offence-search-results', function (req, res) {
    ...
    res.redirect('/ur-feb-2026/B-off-system-MVP/create-case/04-add-charges')
})
...
router.post('/B-off-system-MVP/create-case/04-add-charges', function (req, res) {
    ...
    if (req.body['newCharge_Victim_YesNo'] === 'Yes') {
        res.redirect('/ur-feb-2026/B-off-system-MVP/create-case/04-add-charges-victim')
    }
    else {
        res.redirect('/ur-feb-2026/B-off-system-MVP/create-case/04-charges-summary')
    }
...
router.post('/B-off-system-MVP/create-case/04-charges-summary', function (req, res) {
    if (req.body['add-another'] === 'Yes') {
        ...
        res.redirect('/ur-feb-2026/B-off-system-MVP/create-case/02-first-hearing-details')
    }

})

router.get('/B-off-system-MVP/create-case/04-charges-summary', function (req, res) {
    res.render('ur-feb-2026/B-off-system-MVP/create-case/04-charges-summary', {
...
router.post('/B-off-system-MVP/create-case/remove-charge', function (req, res) {
    ...
    res.redirect('/ur-feb-2026/B-off-system-MVP/create-case/04-remove-charge')
})
...
router.post('/B-off-system-MVP/create-case/05-complexity', function (req, res) {
    ...
    res.redirect('/ur-feb-2026/B-off-system-MVP/create-case/06-monitoring-codes')
})


// Monitoring codes
router.post('/B-off-system-MVP/create-case/06-monitoring-codes', function (req, res) {
    res.redirect('/ur-feb-2026/B-off-system-MVP/create-case/07-cps-staff')
})
...
router.post('/B-off-system-MVP/create-case/07-cps-staff', function (req, res) {
    ...
    res.redirect('/ur-feb-2026/B-off-system-MVP/create-case/08-check-answers')


    // If user is LCC check if there are materials. If not, go to check your answers.
    // if (req.session.data.userType === 'LCC') {
    //     res.redirect('/ur-feb-2026/B-off-system-MVP/create-case/07-want-to-create-folders')
    // }
    // else {
    //     res.redirect('/ur-feb-2026/B-off-system-MVP/create-case/08-check-your-answers') 
    // }    
})
...
router.post('/B-off-system-MVP/create-case/09-confirmation', function (req, res) {
    ...
    if (req.session.data.addMaterials === 'Yes') {
        res.redirect('/ur-feb-2026/B-off-system-MVP/04A-create-or-link-folders')
    }
    else {
        res.redirect('/ur-feb-2026/B-off-system-MVP/03-case-overview')
    }
})
...
router.post('/B-off-system-MVP/04A-create-or-link-folders', function (req, res) {
    ...
    if (req.session.data.newEgressFolder === 1) {
        res.redirect('/ur-feb-2026/B-off-system-MVP/04A-create-egress-folder')
    }

    else if (req.session.data.existingEgressFolder === 1) {
        res.redirect('/ur-feb-2026/B-off-system-MVP/04A-egress-files')
    }

    else if (req.session.data.existingDriveFolder === 1) {
        res.redirect('/ur-feb-2026/B-off-system-MVP/05A-p-drive-files')
    }

    else if (req.session.data.newDriveFolder === 1) {
        res.redirect('/ur-feb-2026/B-off-system-MVP/05A-create-shared-drive-folder')
    }
...
router.get('/B-off-system-MVP/03-case-overview', function (req, res) {
    ...
    // ================================
    res.render('ur-feb-2026/B-off-system-MVP/03-case-overview', {
        materials,
        data,
...
router.get('/ur-feb-2026/manage-materials', function (req, res) {
    ...
    res.render('ur-feb-2026/manage-materials', {
...
router.get('/B-off-system-MVP/new-folder', function (req, res) {
    ...
    res.render('ur-feb-2026/B-off-system-MVP/new-folder');
});
...
router.post('/B-off-system-MVP/new-folder', function (req, res) {
    ...
    if (!newFolderName) {
        return res.render('ur-feb-2026/B-off-system-MVP/new-folder', {
...
router.post('/ur-feb-2026/B-off-system-MVP/case-overview', function (req, res) {
    const data = req.session.data;
    res.render('ur-feb-2026/B-off-system-MVP/03-case-overview', { materials: data.materials || [], data });
});
...
router.post('/B-off-system-MVP/materials-action', function (req, res) {
    ...
    if (!item) return res.redirect('/ur-feb-2026/B-off-system-MVP/03-case-overview');

    return res.render('ur-feb-2026/B-off-system-MVP/rename', { item });
});
...
//         return res.redirect('/ur-feb-2026/B-off-system-MVP/rename-from-list'); // <-- use your real rename page
//     }
...
//     return res.redirect('/ur-feb-2026/B-off-system-MVP/03-case-overview');
//   }
...
router.post('/B-off-system-MVP/rename-from-list', function (req, res) {
    ...
    return res.render('ur-feb-2026/B-off-system-MVP/rename-multiple', {
        selectedItems,
        selectedIds: ids
    });
});
...
//     res.render('ur-feb-2026/B-off-system-MVP/rename', { item });
// });
...
router.post('/B-off-system-MVP/rename', function (req, res) {
    ...
    if (!newName) {
        return res.render('ur-feb-2026/B-off-system-MVP/rename', {
            item,
            error: 'Enter a name'
        });
    }
...
//     res.render('ur-feb-2026/B-off-system-MVP/rename', {
//         item
//     });
// });
...
//     if (parent !== 0) {
//         return res.redirect(`/ur-feb-2026/B-off-system-MVP/03-case-overview?folder=${parent}`);
//     }
...
router.post('/B-off-system-MVP/start-copy', function (req, res) {
    ...
    res.redirect('/ur-feb-2026/B-off-system-MVP/folder-tree-copy');
});
...
router.post('/B-off-system-MVP/start-move', function (req, res) {
    ...
    // Send them to the folder picker page
    res.redirect('/ur-feb-2026/B-off-system-MVP/folder-tree-move');
});
...
router.post('/B-off-system-MVP/copy-material', function (req, res) {
    ...
    if (!ids.length || !destinationFolderId) {
        ...
        return res.redirect('/ur-feb-2026/B-off-system-MVP/folder-tree-copy');
    }
...
router.post('/B-off-system-MVP/move-material', function (req, res) {
    ...
    if (!ids.length || !destinationFolderId) {
        ...
        return res.redirect('/ur-feb-2026/B-off-system-MVP/folder-tree-move');
    }
...
router.get('/B-off-system-MVP/folder-tree-copy', function (req, res) {
    ...
    res.render('ur-feb-2026/B-off-system-MVP/folder-tree-copy', {
        folderTree
    });
});
...
router.get('/B-off-system-MVP/folder-tree-move', function (req, res) {
    ...
    res.render('ur-feb-2026/B-off-system-MVP/folder-tree-move', {
        folderTree
    });
});
