...
function redirectLegacyLccPath(req, res) {
    if (req.path === '/create-case' || req.path.startsWith('/create-case/')) {
        ...
        return res.redirect(`/version-17/lcc${registerCasePath}${getQueryString(req)}`);
    }

    res.redirect(`/version-17/lcc/materials${req.path}${getQueryString(req)}`);
}
...
function getSafeReturnTo(returnTo) {
    if (typeof returnTo !== 'string' || !returnTo.startsWith('/version-17/')) {
        return null;
    }
...
const suspectSummaryPath = '/version-17/lcc/register-case/03B-suspect-summary';
...
function firstSuspectDetailsRoute(data, count) {
    if (
        ...
        return '/version-17/lcc/register-case/03-suspect-details-dob';
    }
    if (shouldAskOffenderType(data.suspectOffenderType[count])) {
        return '/version-17/lcc/register-case/03-suspect-details-offender-type';
    }
    if (hasSuspectDetail(data.suspectGender[count])) {
        return '/version-17/lcc/register-case/03-suspect-details-gender';
    }
    if (hasSuspectDetail(data.suspectDisability[count])) {
        return '/version-17/lcc/register-case/03-suspect-details-disability';
    }
    if (hasSuspectDetail(data.suspectReligion[count])) {
        return '/version-17/lcc/register-case/03-suspect-details-religion';
    }
    if (hasSuspectDetail(data.suspectEthnicity[count])) {
        return '/version-17/lcc/register-case/03-suspect-details-ethnicity';
    }
    if (hasSuspectDetail(data.suspectAlias[count])) {
        return '/version-17/lcc/register-case/03-suspect-details-add-alias';
    }
    if (hasSuspectDetail(data.suspectSDO[count])) {
        return '/version-17/lcc/register-case/03-suspect-details-sdo';
    }
    if (hasSuspectDetail(data.suspectArrestSummons[count])) {
        return '/version-17/lcc/register-case/03-suspect-details-arrest-summons';
    }
...
function nextSuspectDetailsRouteAfterOffenderType(data, count) {
    ...
    return '/version-17/lcc/register-case/03B-suspect-summary';
}

function nextSuspectDetailsRouteAfter(data, count, currentDetail) {
    const remainingRoutes = {
        dob: [
            ['offenderType', () => shouldAskOffenderType(data.suspectOffenderType[count]), '/version-17/lcc/register-case/03-suspect-details-offender-type'],
            ['gender', () => hasSuspectDetail(data.suspectGender[count]), '/version-17/lcc/register-case/03-suspect-details-gender'],
            ['disability', () => hasSuspectDetail(data.suspectDisability[count]), '/version-17/lcc/register-case/03-suspect-details-disability'],
            ['religion', () => hasSuspectDetail(data.suspectReligion[count]), '/version-17/lcc/register-case/03-suspect-details-religion'],
            ['ethnicity', () => hasSuspectDetail(data.suspectEthnicity[count]), '/version-17/lcc/register-case/03-suspect-details-ethnicity'],
            ['alias', () => hasSuspectDetail(data.suspectAlias[count]), '/version-17/lcc/register-case/03-suspect-details-add-alias'],
            ['sdo', () => hasSuspectDetail(data.suspectSDO[count]), '/version-17/lcc/register-case/03-suspect-details-sdo'],
            ['arrestSummons', () => hasSuspectDetail(data.suspectArrestSummons[count]), '/version-17/lcc/register-case/03-suspect-details-arrest-summons']
        ],
        offenderType: [
            ['gender', () => data.suspectGender[count] === 'Gender', '/version-17/lcc/register-case/03-suspect-details-gender'],
            ['disability', () => data.suspectDisability[count] === 'Disability', '/version-17/lcc/register-case/03-suspect-details-disability'],
            ['religion', () => data.suspectReligion[count] === 'Religion', '/version-17/lcc/register-case/03-suspect-details-religion'],
            ['ethnicity', () => data.suspectEthnicity[count] === 'Ethnicity', '/version-17/lcc/register-case/03-suspect-details-ethnicity'],
            ['alias', () => data.suspectAlias[count] === 'Alias details', '/version-17/lcc/register-case/03-suspect-details-add-alias'],
            ['sdo', () => data.suspectSDO[count] === 'Serious Dangerous Offender (SDO)', '/version-17/lcc/register-case/03-suspect-details-sdo'],
            ['arrestSummons', () => data.suspectArrestSummons[count] === 'Arrest summons', '/version-17/lcc/register-case/03-suspect-details-arrest-summons']
        ],
        gender: [
            ['disability', () => hasSuspectDetail(data.suspectDisability[count]), '/version-17/lcc/register-case/03-suspect-details-disability'],
            ['religion', () => hasSuspectDetail(data.suspectReligion[count]), '/version-17/lcc/register-case/03-suspect-details-religion'],
    ...
    return next ? next[2] : '/version-17/lcc/register-case/03B-suspect-summary';
}
...
router.post('/lcc/register-case/01-register-case', function (req, res) {
    ...
    if (errorList.length > 0) {
        return res.render('version-17/lcc/register-case/01-register-case', {
            errors,
            errorList
        })
    }
    ...
    res.redirect('/version-17/lcc/register-case/02-area')
    // }
    // else {
    //     res.render('version-17/lcc/register-case/01-register-case', { 
    //         errors: errors
    //     })
    // }
})
...
router.post('/lcc/register-case/02-area', function (req, res) {
    ...
    if (!area) {
        return res.render('version-17/lcc/register-case/02-area', {
            areaError: 'Select a division or area'
        })
    }

    req.session.data.area = area
    res.redirect('/version-17/lcc/register-case/02-case-details')
})
...
router.post('/lcc/register-case/02-case-details', function (req, res) {
    ...
    if (Object.keys(errors).length > 0) {
        return res.render('version-17/lcc/register-case/02-case-details', {
            errors
        })
    }

    if (req.session.data.suspectDetailsYesNo === 'Yes') {
        res.redirect('/version-17/lcc/register-case/03-add-suspect')
    }
    else {
        ...
        res.redirect('/version-17/lcc/register-case/06-monitoring-codes')
    }
})
...
router.get('/lcc/register-case/03-add-suspect', function (req, res) {
    ...
    res.render('version-17/lcc/register-case/03-add-suspect');
})
...
router.post('/lcc/register-case/03-add-suspect', function (req, res) {
    ...
    if (errorList.length > 0) {
        ...
        return res.render('version-17/lcc/register-case/03-add-suspect', {
            errors,
            errorList
        })
    }
...
router.post('/lcc/register-case/03-suspect-details-dob', function (req, res) {
    ...
    if (errorList.length > 0) {
        return res.render('version-17/lcc/register-case/03-suspect-details-dob', {
            errors,
            errorList
        })
    }
    ...
    if (isUnder18(
        ...
        return res.redirect('/version-17/lcc/register-case/03-suspect-details-offender-type')
    }

    if (shouldAskOffenderType(req.session.data.suspectOffenderType[count])) {
        res.redirect('/version-17/lcc/register-case/03-suspect-details-offender-type')
    }
    else if (hasSuspectDetail(req.session.data.suspectGender[count])) {
        res.redirect('/version-17/lcc/register-case/03-suspect-details-gender')
    }
    else if (hasSuspectDetail(req.session.data.suspectDisability[count])) {
        res.redirect('/version-17/lcc/register-case/03-suspect-details-disability')
    }
    else if (hasSuspectDetail(req.session.data.suspectReligion[count])) {
        res.redirect('/version-17/lcc/register-case/03-suspect-details-religion')
    }
    else if (hasSuspectDetail(req.session.data.suspectEthnicity[count])) {
        res.redirect('/version-17/lcc/register-case/03-suspect-details-ethnicity')
    }
    else if (hasSuspectDetail(req.session.data.suspectAlias[count])) {
        res.redirect('/version-17/lcc/register-case/03-suspect-details-add-alias')
    }
    else if (hasSuspectDetail(req.session.data.suspectSDO[count])) {
        res.redirect('/version-17/lcc/register-case/03-suspect-details-sdo')
    }
    else if (hasSuspectDetail(req.session.data.suspectArrestSummons[count])) {
        res.redirect('/version-17/lcc/register-case/03-suspect-details-arrest-summons')
    }
    else {
        redirectToSuspectSummary(req, res)
    }
...
router.post('/lcc/register-case/03-suspect-details-gender', function (req, res) {
    ...
    if (!gender) {
        return res.render('version-17/lcc/register-case/03-suspect-details-gender', {
            errors: {
            ...
            errorList: [{
                ...
                skipHref: '/version-17/lcc/register-case/03-suspect-details-gender-unknown'
            }]
        })
    }
...
router.post('/lcc/register-case/03-suspect-details-disability', function (req, res) {
    ...
    if (!disability) {
        return res.render('version-17/lcc/register-case/03-suspect-details-disability', {
            errors: {
            ...
            errorList: [{
                ...
                skipHref: '/version-17/lcc/register-case/03-suspect-details-disability-unknown'
            }]
        })
    }
...
router.post('/lcc/register-case/03-suspect-details-religion', function (req, res) {
    ...
    if (!religion) {
        return res.render('version-17/lcc/register-case/03-suspect-details-religion', {
            errors: {
            ...
            errorList: [{
                ...
                skipHref: '/version-17/lcc/register-case/03-suspect-details-religion-unknown'
            }]
        })
    }
...
router.post('/lcc/register-case/03-suspect-details-ethnicity', function (req, res) {
    ...
    if (!ethnicity) {
        return res.render('version-17/lcc/register-case/03-suspect-details-ethnicity', {
            errors: {
            ...
            errorList: [{
                ...
                skipHref: '/version-17/lcc/register-case/03-suspect-details-ethnicity-unknown'
            }]
        })
    }
...
router.post('/lcc/register-case/03-suspect-details-add-alias', function (req, res) {
    ...
    if (!aliasLastName) {
        return res.render('version-17/lcc/register-case/03-suspect-details-add-alias', {
            errors: {
            ...
            errorList: [{
                ...
                skipHref: '/version-17/lcc/register-case/03-suspect-details-alias-unknown'
            }]
        })
    }
    ...
    res.redirect('/version-17/lcc/register-case/03-suspect-details-alias-summary')
})
...
router.post('/lcc/register-case/03-suspect-details-alias-summary', function (req, res) {
    ...
    if (!addAnother) {
        return res.render('version-17/lcc/register-case/03-suspect-details-alias-summary', {
            errors: {
...
router.post('/lcc/register-case/03-suspect-details-arrest-summons', function (req, res) {
    ...
    if (!arrestSummons) {
        return res.render('version-17/lcc/register-case/03-suspect-details-arrest-summons', {
...
router.post('/lcc/register-case/03-suspect-details-offender-type', function (req, res) {
    ...
    if (!offenderType) {
        return res.render('version-17/lcc/register-case/03-suspect-details-offender-type', {
            errors: {
            ...
            errorList: [{
                ...
                skipHref: '/version-17/lcc/register-case/03-suspect-details-offender-type-unknown'
            }]
        })
    }
...
router.post('/lcc/register-case/03B-suspect-summary', function (req, res) {
    ...
    if (!addAnother) {
        return res.render('version-17/lcc/register-case/03B-suspect-summary', {
            errors: {
    ...
    if (addAnother === 'Yes') {
        ...
        if (returnTo) {
            return res.redirect('/version-17/lcc/register-case/04-want-to-add-charges')
        }

        res.redirect('/version-17/lcc/register-case/04-want-to-add-charges')
        // res.redirect('/version-17/lcc/register-case/06-monitoring-codes') 
    }
})
...
router.post('/lcc/register-case/remove-suspect', function (req, res) {
    ...
    res.redirect('/version-17/lcc/register-case/03-remove-suspect')
})
...
router.get('/lcc/register-case/03-edit-suspect/:id', function (req, res) {
    ...
    if (!Number.isInteger(suspectId) || suspectId < 0) {
        return res.redirect('/version-17/lcc/register-case/08-check-answers')
    }
...
router.post('/lcc/register-case/04-want-to-add-charges', function (req, res) {
    ...
    if (req.session.data.wantToAddCharges === 'Yes') {
        if (req.session.data.suspectCount === 1) {
            ...
            res.redirect('/version-17/lcc/register-case/04-charges-offence-search')
        }
        else {
            res.redirect('/version-17/lcc/register-case/04-add-charges-suspect')
        }
    }
    else {
        if (returnTo) {
...
router.post('/lcc/register-case/04-charges-offence-search', function (req, res) {
    ...
    res.redirect('/version-17/lcc/register-case/04-charges-offence-search-results')
})
...
router.post('/lcc/register-case/04-charges-offence-search-results', function (req, res) {
    ...
    res.redirect('/version-17/lcc/register-case/04-add-charges')
})
...
router.post('/lcc/register-case/04-add-charges', function (req, res) {
    ...
    if (Object.keys(chargeErrors).length > 0) {
        return res.render('version-17/lcc/register-case/04-add-charges', {
            chargeErrors
        })
    }
    ...
    if (req.body['newCharge_Victim_YesNo'] === 'Yes') {
        res.redirect('/version-17/lcc/register-case/04-add-charges-victim')
    }
    else {
        res.redirect('/version-17/lcc/register-case/04-charges-summary')
    }
...
router.post('/lcc/register-case/04-charges-summary', function (req, res) {
    ...
    if (!addAnother) {
        return res.render('version-17/lcc/register-case/04-charges-summary', {
    ...
    if (addAnother === 'Yes') {
        ...
        if (returnTo) {
            return res.redirect('/version-17/lcc/register-case/02-first-hearing-details')
        }

        res.redirect('/version-17/lcc/register-case/02-first-hearing-details')
    }

})

router.get('/lcc/register-case/04-charges-summary', function (req, res) {
    res.render('version-17/lcc/register-case/04-charges-summary', {
        grouped: req.session.data.grouped
    });
})
...
router.post('/lcc/register-case/remove-charge', function (req, res) {
    ...
    res.redirect('/version-17/lcc/register-case/04-remove-charge')
})
...
router.post('/lcc/register-case/06-monitoring-codes', function (req, res) {
    res.redirect('/version-17/lcc/register-case/07-cps-staff')
})
...
router.post('/lcc/register-case/07-cps-staff', function (req, res) {
    ...
    //     res.redirect('/version-17/lcc/register-case/07-want-to-create-folders')
    // }
    // else {
    //     res.redirect('/version-17/lcc/register-case/08-check-your-answers') 
    // }    
})
...
router.get('/lcc/register-case/12-check-answers', function (req, res) {
    setRegisterCaseRegistered(req.session.data)
    res.render('version-17/lcc/register-case/12-check-answers')
})
...
function redirectRegisterCaseMaterialsConfirmation(req, res) {
    if (req.session.data.newEgressFolder === 1 || req.session.data.existingEgressFolder === 1 || req.session.data.newDriveFolder === 1 || req.session.data.existingDriveFolder === 1) {
        res.redirect('/version-17/lcc/register-case/12-check-answers')
    }
    else {
        res.redirect('/version-17/lcc/register-case/10-confirmation')
    }
...
router.post('/lcc/materials/04A-create-or-link-folders', function (req, res) {
    ...
    if (req.session.data.existingEgressFolder === 1) {
        res.redirect('/version-17/lcc/materials/04A-egress-files')
    }
        ...
        res.redirect('/version-17/lcc/materials/05A-create-shared-drive-folder')
    }
...
function renderCaseOverviewPage(pageView, activeTab) {
    ...
    // ================================
    res.render(`version-17/lcc/materials/${pageView}`, {
        materials,
        data,
...
router.get('/lcc/materials/03-case-overview', function (req, res) {
    ...
    res.redirect(`/version-17/lcc/materials/${target}${queryString ? `?${queryString}` : ''}`);
});
...
router.get('/version-17/manage-materials', function (req, res) {
    ...
    res.render('version-17/manage-materials', {
...
router.post('/lcc/materials/case-overview-folder', function (req, res) {
    ...
    res.redirect(`/version-17/lcc/materials/${targetPage}${transferViewQuery}`)
})
...
router.post('/lcc/materials/transfer-egress-folder', function (req, res) {
    ...
    res.redirect('/version-17/lcc/materials/transfer-materials?transferView=egress');
});
...
router.get('/lcc/materials/new-folder', function (req, res) {
    ...
    res.render('version-17/lcc/materials/new-folder');
});
...
router.post('/lcc/materials/new-folder', function (req, res) {
    ...
    if (!newFolderName) {
        return res.render('version-17/lcc/materials/new-folder', {
        ...
        sourceLines: [
            {
                ...
                href: `/version-17/lcc/materials/manage-materials?folderId=${newFolder.id}`
            }
        ]
    });
...
router.post('/version-17/lcc/materials/case-overview', function (req, res) {
    const data = req.session.data;
    res.render('version-17/lcc/materials/manage-materials', { materials: data.materials || [], data });
});
...
router.post('/lcc/materials/delete', function (req, res) {
    ...
    res.render('version-17/lcc/materials/delete', {
        data: {
            ...data,
            ...
            sourceLines: [
                {
                    ...
                    href: sourceParents.length === 1 ? `/version-17/lcc/materials/03-case-overview?folderId=${sourceParentIds[0]}` : null
                }
            ]
        });
    }
...
router.post('/lcc/materials/materials-action', function (req, res) {
    ...
    if (!item) return res.redirect('/version-17/lcc/materials/03-case-overview');

    return res.render('version-17/lcc/materials/rename', { item });
});
...
//         return res.redirect('/version-17/lcc/materials/rename-from-list'); // <-- use your real rename page
//     }
...
router.post('/lcc/materials/rename-from-list', function (req, res) {
    ...
    return res.render('version-17/lcc/materials/rename-multiple', {
        selectedItems,
        selectedIds: ids
    });
});
            ...
            sourceLines: [
                {
                    ...
                    href: locationPaths.length === 1 ? `/version-17/lcc/materials/03-case-overview?folderId=${locationIds[0]}` : null
                }
            ]
        });
    }
...
//     res.render('version-17/lcc/materials/rename', { item });
// });
...
router.post('/lcc/materials/rename', function (req, res) {
    ...
    if (!newName) {
        return res.render('version-17/lcc/materials/rename', {
            item,
            error: 'Enter a name'
        });
    }
        ...
        sourceLines: [
            {
                ...
                href: `/version-17/lcc/materials/03-case-overview?folderId=${item.parentId ?? 0}`
            }
        ]
    });
...
//     res.render('version-17/lcc/materials/rename', {
//         item
//     });
// });
...
//     if (parent !== 0) {
//         return res.redirect(`/version-17/lcc/materials/03-case-overview?folder=${parent}`);
//     }
...
function getTransferEgressFolderHref(folderId) {
    return `/version-17/lcc/materials/transfer-materials?transferView=egress&transferEgressFolderId=${encodeURIComponent(folderId || 100)}`;
}
        ...
        pushMaterialsActivity(data, {
            ...
            sourceLines: [
                ...
                },
                {
                    ...
                    href: `/version-17/lcc/materials/transfer-materials?transferView=shared-drive&transferSharedDriveFolderId=${destinationFolderId}`
                }
            ]
        });
    }
            ...
            sourceLines: [
                {
                    label: sourceParents.length === 1 ? 'Original location:' : 'Original locations:',
                    value: sourceParents.length === 1 ? sourceParents[0] : 'Multiple locations',
                    href: sourceParents.length === 1 ? `/version-17/lcc/materials/transfer-materials?transferView=shared-drive&transferSharedDriveFolderId=${sourceParentIds[0]}` : null
                },
                {
                    label: 'New location:',
        ...
        pushMaterialsActivity(req.session.data, {
            ...
            sourceLines: [
                ...
                },
                {
                    label: 'New location:',
                    value: getFolderPathLabel(materials, destinationFolderId, data),
                    href: `/version-17/lcc/materials/03-case-overview?folderId=${destinationFolderId}`
                }
            ]
        });
    }
...
router.post('/lcc/materials/start-copy', function (req, res) {
    ...
    res.redirect('/version-17/lcc/materials/folder-tree-copy');
});
...
router.post('/lcc/materials/start-transfer-shared-drive-copy', function (req, res) {
    ...
    res.redirect('/version-17/lcc/materials/folder-tree-egress-copy');
});
...
router.post('/lcc/materials/start-move', function (req, res) {
    ...
    // Send them to the folder picker page
    res.redirect('/version-17/lcc/materials/folder-tree-move');
});
...
router.post('/lcc/materials/copy-material', function (req, res) {
    ...
    if (req.session.data.copySource === 'egress') {
        if (!ids.length || !destinationFolderId) {
            ...
            return res.redirect('/version-17/lcc/materials/folder-tree-copy');
        }
        ...
        return res.redirect('/version-17/lcc/materials/transfer-materials?transferView=egress');
    }
...
router.post('/lcc/materials/move-material', function (req, res) {
    ...
    if (req.session.data.moveSource === 'egress') {
        if (!ids.length || !destinationFolderId) {
            ...
            return res.redirect('/version-17/lcc/materials/folder-tree-move');
        }
...
router.post('/lcc/materials/copy-transfer-shared-drive-to-egress', function (req, res) {
    ...
    if (!ids.length || !destinationFolderId) {
        req.session.data.copyError = "Select at least one item and a destination folder";
        return res.redirect('/version-17/lcc/materials/folder-tree-egress-copy');
    }
    ...
    return res.redirect('/version-17/lcc/materials/transfer-materials?transferView=shared-drive');
});
...
router.get('/lcc/materials/folder-tree-copy', function (req, res) {
    ...
    res.render('version-17/lcc/materials/folder-tree-copy', {
        folderTree
    });
});
...
router.get('/lcc/materials/folder-tree-egress-copy', function (req, res) {
    ...
    res.render('version-17/lcc/materials/folder-tree-egress-copy', {
...
router.get('/lcc/materials/folder-tree-move', function (req, res) {
    ...
    res.render('version-17/lcc/materials/folder-tree-move', {
        folderTree
    });
});
...
router.get('/lcc/materials/order-materials', (req, res) => {
    ...
    res.render('version-17/lcc/materials/order-materials', {
        folderId,
        breadcrumbs,
        children
    });
...
router.post('/lcc/materials/order-materials', (req, res) => {
    ...
    if (shouldInterrupt) {
        ...
        return res.redirect('/version-17/lcc/materials/order-interrupt');
    }
...
router.post('/lcc/register-case/cancel-interrupt', (req, res) => {
    ...
    if (req.body['cancel-registration'] == 'Yes, cancel registration') {
        return res.redirect('/version-17/lcc/register-case/00-homepage');
    }
...
router.post('/lcc/materials/disconnect-shared-drive', (req, res) => {
    ...
    if (!choice) {
        return res.render('version-17/lcc/materials/disconnect-shared-drive', {
...
router.post('/lcc/materials/disconnect-egress', (req, res) => {
    ...
    if (!choice) {
        return res.render('version-17/lcc/materials/disconnect-egress', {
    ...
    if (choice === 'Yes') {
        ...
        return res.redirect('/version-17/lcc/materials/disconnect-egress-confirmation');
    }
