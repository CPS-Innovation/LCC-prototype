...
const version = 'ur-apr-2026-closed'

function getSafeReturnTo(returnTo) {
    if (typeof returnTo !== 'string' || !returnTo.startsWith('/ur-apr-2026-closed/')) {
        return null;
    }
...
function nextSuspectDetailsRouteAfterOffenderType(data, count) {
    if (data.suspectGender[count] != undefined) {
        return '/ur-apr-2026-closed/B-off-system-MVP/create-case/03-suspect-details-gender';
    }
    if (data.suspectDisability[count] != undefined) {
        return '/ur-apr-2026-closed/B-off-system-MVP/create-case/03-suspect-details-disability';
    }
    if (data.suspectReligion[count] != undefined) {
        return '/ur-apr-2026-closed/B-off-system-MVP/create-case/03-suspect-details-religion';
    }
    if (data.suspectEthnicity[count] != undefined) {
        return '/ur-apr-2026-closed/B-off-system-MVP/create-case/03-suspect-details-ethnicity';
    }
    if (data.suspectAlias[count] != undefined) {
        return '/ur-apr-2026-closed/B-off-system-MVP/create-case/03-suspect-details-add-alias';
    }
    if (data.suspectSDO[count] != undefined) {
        return '/ur-apr-2026-closed/B-off-system-MVP/create-case/03-suspect-details-sdo';
    }
    if (data.suspectArrestSummons[count] != undefined) {
        return '/ur-apr-2026-closed/B-off-system-MVP/create-case/03-suspect-details-arrest-summons';
    }

    return '/ur-apr-2026-closed/B-off-system-MVP/create-case/03B-suspect-summary';
}
...
router.post('/B-off-system-MVP/create-case/01-register-case', function (req, res) {
    ...
    if (errorList.length > 0) {
        return res.render('ur-apr-2026-closed/B-off-system-MVP/create-case/01-register-case', {
            errors,
            errorList
        })
    }
    ...
    res.redirect('/ur-apr-2026-closed/B-off-system-MVP/create-case/02-area')
    // }
    // else {
    //     res.render('ur-apr-2026-closed/B-off-system-MVP/create-case/01-register-case', { 
    //         errors: errors
    //     })
    // }
})
...
router.post('/B-off-system-MVP/create-case/02-area', function (req, res) {
    ...
    if (!area) {
        return res.render('ur-apr-2026-closed/B-off-system-MVP/create-case/02-area', {
            areaError: 'Select a division or area'
        })
    }

    req.session.data.area = area
    res.redirect('/ur-apr-2026-closed/B-off-system-MVP/create-case/02-case-details')
})
...
router.post('/B-off-system-MVP/create-case/02-case-details', function (req, res) {
    ...
    if (Object.keys(errors).length > 0) {
        return res.render('ur-apr-2026-closed/B-off-system-MVP/create-case/02-case-details', {
            errors
        })
    }

    if (req.session.data.suspectDetailsYesNo === 'Yes') {
        res.redirect('/ur-apr-2026-closed/B-off-system-MVP/create-case/03-add-suspect')
    }
    else {
        ...
        res.redirect('/ur-apr-2026-closed/B-off-system-MVP/create-case/06-monitoring-codes')
    }
})
...
router.post('/B-off-system-MVP/create-case/03-add-suspect', function (req, res) {
    ...
    if (errorList.length > 0) {
        ...
        return res.render('ur-apr-2026-closed/B-off-system-MVP/create-case/03-add-suspect', {
            errors,
            errorList
        })
    }
    ...
    if (req.session.data.suspectDOB[id] != undefined) {
        res.redirect('/ur-apr-2026-closed/B-off-system-MVP/create-case/03-suspect-details-dob')
    }
    else if (shouldAskOffenderType(req.session.data.suspectOffenderType[id])) {
        res.redirect('/ur-apr-2026-closed/B-off-system-MVP/create-case/03-suspect-details-offender-type')
    }
    else if (req.session.data.suspectGender[id] != undefined) {
        res.redirect('/ur-apr-2026-closed/B-off-system-MVP/create-case/03-suspect-details-gender')
    }
    else if (req.session.data.suspectDisability[id] != undefined) {
        res.redirect('/ur-apr-2026-closed/B-off-system-MVP/create-case/03-suspect-details-disability')
    }
    else if (req.session.data.suspectReligion[id] != undefined) {
        res.redirect('/ur-apr-2026-closed/B-off-system-MVP/create-case/03-suspect-details-religion')
    }
    else if (req.session.data.suspectEthnicity[id] != undefined) {
        res.redirect('/ur-apr-2026-closed/B-off-system-MVP/create-case/03-suspect-details-ethnicity')
    }
    else if (req.session.data.suspectAlias[id] != undefined) {
        res.redirect('/ur-apr-2026-closed/B-off-system-MVP/create-case/03-suspect-details-add-alias')
    }
    else if (req.session.data.suspectSDO[id] != undefined) {
        res.redirect('/ur-apr-2026-closed/B-off-system-MVP/create-case/03-suspect-details-sdo')
    }
    else if (req.session.data.suspectArrestSummons[id] != undefined) {
        res.redirect('/ur-apr-2026-closed/B-off-system-MVP/create-case/03-suspect-details-arrest-summons')
    }
    else {
        res.redirect('/ur-apr-2026-closed/B-off-system-MVP/create-case/03B-suspect-summary')
    }
...
router.post('/B-off-system-MVP/create-case/03-suspect-details-dob', function (req, res) {
    ...
    if (errorList.length > 0) {
        return res.render('ur-apr-2026-closed/B-off-system-MVP/create-case/03-suspect-details-dob', {
            errors,
            errorList
        })
    }
    ...
    if (isUnder18(
        ...
        return res.redirect('/ur-apr-2026-closed/B-off-system-MVP/create-case/03-suspect-details-offender-type')
    }
...
router.post('/B-off-system-MVP/create-case/03-suspect-details-gender', function (req, res) {
    ...
    if (!gender) {
        return res.render('ur-apr-2026-closed/B-off-system-MVP/create-case/03-suspect-details-gender', {
            errors: {
...
router.post('/B-off-system-MVP/create-case/03-suspect-details-disability', function (req, res) {
    ...
    if (!disability) {
        return res.render('ur-apr-2026-closed/B-off-system-MVP/create-case/03-suspect-details-disability', {
            errors: {
...
router.post('/B-off-system-MVP/create-case/03-suspect-details-religion', function (req, res) {
    ...
    if (!religion) {
        return res.render('ur-apr-2026-closed/B-off-system-MVP/create-case/03-suspect-details-religion', {
            errors: {
...
router.post('/B-off-system-MVP/create-case/03-suspect-details-ethnicity', function (req, res) {
    ...
    if (!ethnicity) {
        return res.render('ur-apr-2026-closed/B-off-system-MVP/create-case/03-suspect-details-ethnicity', {
            errors: {
...
router.post('/B-off-system-MVP/create-case/03-suspect-details-add-alias', function (req, res) {
    ...
    if (!aliasLastName) {
        return res.render('ur-apr-2026-closed/B-off-system-MVP/create-case/03-suspect-details-add-alias', {
            errors: {
    ...
    res.redirect('/ur-apr-2026-closed/B-off-system-MVP/create-case/03-suspect-details-alias-summary')
})
...
router.post('/B-off-system-MVP/create-case/03-suspect-details-alias-summary', function (req, res) {
    ...
    if (!addAnother) {
        return res.render('ur-apr-2026-closed/B-off-system-MVP/create-case/03-suspect-details-alias-summary', {
            errors: {
...
router.post('/B-off-system-MVP/create-case/03-suspect-details-arrest-summons', function (req, res) {
    ...
    if (!arrestSummons) {
        return res.render('ur-apr-2026-closed/B-off-system-MVP/create-case/03-suspect-details-arrest-summons', {
...
router.post('/B-off-system-MVP/create-case/03-suspect-details-offender-type', function (req, res) {
    ...
    if (!offenderType) {
        return res.render('ur-apr-2026-closed/B-off-system-MVP/create-case/03-suspect-details-offender-type', {
            errors: {
...
router.post('/B-off-system-MVP/create-case/03B-suspect-summary', function (req, res) {
    ...
    if (!addAnother) {
        return res.render('ur-apr-2026-closed/B-off-system-MVP/create-case/03B-suspect-summary', {
            errors: {
    ...
    if (addAnother === 'Yes') {
        ...
        if (returnTo) {
            return res.redirect('/ur-apr-2026-closed/B-off-system-MVP/create-case/04-want-to-add-charges')
        }

        res.redirect('/ur-apr-2026-closed/B-off-system-MVP/create-case/04-want-to-add-charges')
        // res.redirect('/ur-apr-2026-closed/B-off-system-MVP/create-case/06-monitoring-codes') 
    }
})
...
router.post('/B-off-system-MVP/create-case/remove-suspect', function (req, res) {
    ...
    res.redirect('/ur-apr-2026-closed/B-off-system-MVP/create-case/03-remove-suspect')
})
...
router.post('/B-off-system-MVP/create-case/04-want-to-add-charges', function (req, res) {
    ...
    if (req.session.data.wantToAddCharges === 'Yes') {
        if (req.session.data.suspectCount === 1) {
            ...
            res.redirect('/ur-apr-2026-closed/B-off-system-MVP/create-case/04-charges-offence-search')
        }
        else {
            res.redirect('/ur-apr-2026-closed/B-off-system-MVP/create-case/04-add-charges-suspect')
        }
    }
    else {
        if (returnTo) {
...
router.post('/B-off-system-MVP/create-case/04-charges-offence-search', function (req, res) {
    ...
    res.redirect('/ur-apr-2026-closed/B-off-system-MVP/create-case/04-charges-offence-search-results')
})
...
router.post('/B-off-system-MVP/create-case/04-charges-offence-search-results', function (req, res) {
    ...
    res.redirect('/ur-apr-2026-closed/B-off-system-MVP/create-case/04-add-charges')
})
...
router.post('/B-off-system-MVP/create-case/04-add-charges', function (req, res) {
    ...
    if (Object.keys(chargeErrors).length > 0) {
        return res.render('ur-apr-2026-closed/B-off-system-MVP/create-case/04-add-charges', {
            chargeErrors
        })
    }
    ...
    if (req.body['newCharge_Victim_YesNo'] === 'Yes') {
        res.redirect('/ur-apr-2026-closed/B-off-system-MVP/create-case/04-add-charges-victim')
    }
    else {
        res.redirect('/ur-apr-2026-closed/B-off-system-MVP/create-case/04-charges-summary')
    }
...
router.post('/B-off-system-MVP/create-case/04-charges-summary', function (req, res) {
    ...
    if (!addAnother) {
        return res.render('ur-apr-2026-closed/B-off-system-MVP/create-case/04-charges-summary', {
    ...
    if (addAnother === 'Yes') {
        ...
        if (returnTo) {
            return res.redirect('/ur-apr-2026-closed/B-off-system-MVP/create-case/02-first-hearing-details')
        }

        res.redirect('/ur-apr-2026-closed/B-off-system-MVP/create-case/02-first-hearing-details')
    }

})

router.get('/B-off-system-MVP/create-case/04-charges-summary', function (req, res) {
    res.render('ur-apr-2026-closed/B-off-system-MVP/create-case/04-charges-summary', {
        grouped: req.session.data.grouped
    });
})
...
router.post('/B-off-system-MVP/create-case/remove-charge', function (req, res) {
    ...
    res.redirect('/ur-apr-2026-closed/B-off-system-MVP/create-case/04-remove-charge')
})
...
router.post('/B-off-system-MVP/create-case/05-complexity', function (req, res) {
    ...
    res.redirect('/ur-apr-2026-closed/B-off-system-MVP/create-case/08-check-answers')
})


// Monitoring codes
router.post('/B-off-system-MVP/create-case/06-monitoring-codes', function (req, res) {
    res.redirect('/ur-apr-2026-closed/B-off-system-MVP/create-case/07-cps-staff')
})
...
router.post('/B-off-system-MVP/create-case/07-cps-staff', function (req, res) {
    ...
    //     res.redirect('/ur-apr-2026-closed/B-off-system-MVP/create-case/07-want-to-create-folders')
    // }
    // else {
    //     res.redirect('/ur-apr-2026-closed/B-off-system-MVP/create-case/08-check-your-answers') 
    // }    
})
...
router.post('/B-off-system-MVP/create-case/09-confirmation', function (req, res) {
    ...
    if (req.session.data.addMaterials === 'Yes') {
        res.redirect('/ur-apr-2026-closed/B-off-system-MVP/04A-create-or-link-folders')
    }
    else {
        res.redirect('/ur-apr-2026-closed/B-off-system-MVP/create-case/case-details-placeholder')
        // res.redirect('/ur-apr-2026-closed/B-off-system-MVP/03-case-overview')
    }
})
...
router.post('/B-off-system-MVP/04A-create-or-link-folders', function (req, res) {
    ...
    if (req.session.data.newEgressFolder === 1) {
        res.redirect('/ur-apr-2026-closed/B-off-system-MVP/04A-create-egress-folder')
    }

    else if (req.session.data.existingEgressFolder === 1) {
        res.redirect('/ur-apr-2026-closed/B-off-system-MVP/04A-egress-files')
    }

    else if (req.session.data.existingDriveFolder === 1) {
        res.redirect('/ur-apr-2026-closed/B-off-system-MVP/05A-p-drive-files')
    }

    else if (req.session.data.newDriveFolder === 1) {
        res.redirect('/ur-apr-2026-closed/B-off-system-MVP/05A-create-shared-drive-folder')
    }
...
router.get('/B-off-system-MVP/03-case-overview', function (req, res) {
    ...
    // ================================
    res.render('ur-apr-2026-closed/B-off-system-MVP/03-case-overview', {
        materials,
        data,
...
router.get('/ur-apr-2026-closed/manage-materials', function (req, res) {
    ...
    res.render('ur-apr-2026-closed/manage-materials', {
...
router.get('/B-off-system-MVP/new-folder', function (req, res) {
    ...
    res.render('ur-apr-2026-closed/B-off-system-MVP/new-folder');
});
...
router.post('/B-off-system-MVP/new-folder', function (req, res) {
    ...
    if (!newFolderName) {
        return res.render('ur-apr-2026-closed/B-off-system-MVP/new-folder', {
        ...
        sourceLines: [
            {
                ...
                href: `/ur-apr-2026-closed/B-off-system-MVP/03-case-overview?folderId=${newFolder.id}`
            }
        ]
    });
...
router.post('/ur-apr-2026-closed/B-off-system-MVP/case-overview', function (req, res) {
    const data = req.session.data;
    res.render('ur-apr-2026-closed/B-off-system-MVP/03-case-overview', { materials: data.materials || [], data });
});
...
router.post('/B-off-system-MVP/delete', function (req, res) {
    ...
    res.render('ur-apr-2026-closed/B-off-system-MVP/delete', {
        data: {
            ...data,
            ...
            sourceLines: [
                {
                    ...
                    href: sourceParents.length === 1 ? `/ur-apr-2026-closed/B-off-system-MVP/03-case-overview?folderId=${sourceParentIds[0]}` : null
                }
            ]
        });
    }
...
router.post('/B-off-system-MVP/materials-action', function (req, res) {
    ...
    if (!item) return res.redirect('/ur-apr-2026-closed/B-off-system-MVP/03-case-overview');

    return res.render('ur-apr-2026-closed/B-off-system-MVP/rename', { item });
});
...
//         return res.redirect('/ur-apr-2026-closed/B-off-system-MVP/rename-from-list'); // <-- use your real rename page
//     }
...
//     return res.redirect('/ur-apr-2026-closed/B-off-system-MVP/03-case-overview');
//   }
...
router.post('/B-off-system-MVP/rename-from-list', function (req, res) {
    ...
    return res.render('ur-apr-2026-closed/B-off-system-MVP/rename-multiple', {
        selectedItems,
        selectedIds: ids
    });
});
            ...
            sourceLines: [
                {
                    ...
                    href: locationPaths.length === 1 ? `/ur-apr-2026-closed/B-off-system-MVP/03-case-overview?folderId=${locationIds[0]}` : null
                }
            ]
        });
    }
...
//     res.render('ur-apr-2026-closed/B-off-system-MVP/rename', { item });
// });
...
router.post('/B-off-system-MVP/rename', function (req, res) {
    ...
    if (!newName) {
        return res.render('ur-apr-2026-closed/B-off-system-MVP/rename', {
            item,
            error: 'Enter a name'
        });
    }
        ...
        sourceLines: [
            {
                ...
                href: `/ur-apr-2026-closed/B-off-system-MVP/03-case-overview?folderId=${item.parentId ?? 0}`
            }
        ]
    });
...
//     res.render('ur-apr-2026-closed/B-off-system-MVP/rename', {
//         item
//     });
// });
...
//     if (parent !== 0) {
//         return res.redirect(`/ur-apr-2026-closed/B-off-system-MVP/03-case-overview?folder=${parent}`);
//     }
        ...
        pushMaterialsActivity(req.session.data, {
            ...
            sourceLines: [
                ...
                },
                {
                    ...
                    href: `/ur-apr-2026-closed/B-off-system-MVP/03-case-overview?folderId=${destinationFolderId}`
                }
            ]
        });
    }
...
router.post('/B-off-system-MVP/start-copy', function (req, res) {
    ...
    res.redirect('/ur-apr-2026-closed/B-off-system-MVP/folder-tree-copy');
});
...
router.post('/B-off-system-MVP/start-move', function (req, res) {
    ...
    // Send them to the folder picker page
    res.redirect('/ur-apr-2026-closed/B-off-system-MVP/folder-tree-move');
});
...
router.post('/B-off-system-MVP/copy-material', function (req, res) {
    ...
    if (!ids.length || !destinationFolderId) {
        ...
        return res.redirect('/ur-apr-2026-closed/B-off-system-MVP/folder-tree-copy');
    }
...
router.post('/B-off-system-MVP/move-material', function (req, res) {
    ...
    if (!ids.length || !destinationFolderId) {
        ...
        return res.redirect('/ur-apr-2026-closed/B-off-system-MVP/folder-tree-move');
    }
...
// New code for ur-apr-2026-closed
router.get('/B-off-system-MVP/folder-tree-copy', function (req, res) {
    ...
    res.render('ur-apr-2026-closed/B-off-system-MVP/folder-tree-copy', {
        folderTree
    });
});
...
router.get('/B-off-system-MVP/folder-tree-move', function (req, res) {
    ...
    res.render('ur-apr-2026-closed/B-off-system-MVP/folder-tree-move', {
        folderTree
    });
});
...
router.get('/B-off-system-MVP/order-materials', (req, res) => {
    ...
    res.render('ur-apr-2026-closed/B-off-system-MVP/order-materials', {
        folderId,
        breadcrumbs,
        children
    });
...
router.post('/B-off-system-MVP/order-materials', (req, res) => {
    ...
    if (shouldInterrupt) {
        ...
        return res.redirect('/ur-apr-2026-closed/B-off-system-MVP/order-interrupt');
    }
...
router.post('/B-off-system-MVP/create-case/cancel-interrupt', (req, res) => {
    ...
    if (req.body['cancel-registration'] == 'Yes, cancel registration') {
        return res.redirect('/ur-apr-2026-closed/B-off-system-MVP/create-case/00-homepage');
    }
