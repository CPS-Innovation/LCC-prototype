...
$(document).ready(function() {
     ...
     $urDec2025.find("#show_Materials_Actions").click(function(){
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const actions = document.getElementById('materials_Actions');
  ...
  document.addEventListener('click', function (e) {
    if (!toggleBtn.contains(e.target) && !actions.contains(e.target)) {
      actions.style.display = 'none';
...
$(document).mouseup(function(e) {
     var $urDec2025 = $('.ur-dec-2025');
     var container = $urDec2025.find("#materials_Actions");

     if (!container.is(e.target) && container.has(e.target).length === 0) {
          container.hide();
          $urDec2025.find('#show_Materials_Actions').removeClass('active');
     }

     var container_V2 = $urDec2025.find("#comms_Actions");

     if (!container_V2.is(e.target) && container_V2.has(e.target).length === 0) {
          container_V2.hide();
          $urDec2025.find('#show_Comms_Actions').removeClass('active');
     }
...
$(document).ready(function () {
    ...
    // ************** UNUSED (search-item, searchURNModal and searchURNModal2) ************** //
