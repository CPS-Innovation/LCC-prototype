...
///////////////////////////////////////////////////// Monica CODE - UPDATED ACTIONS MENU /////////////////////////////////////////////////////
// document.addEventListener('DOMContentLoaded', () => {
//   const table = document.getElementById('materials_table');
//   if (!table) return;

//   const checkboxes = table.querySelectorAll('input[name="materials_document"]');
//   const actionBtn = document.getElementById('show_Materials_Actions');
//   const actionMenu = document.getElementById('materials_Actions');

//   // Match your HTML buttons
//   const renameBtn = actionMenu.querySelector('.rename-Document');
//   const discardForm = actionMenu.querySelector('form[action="B-discard_material"]');
//   const discardBtn = discardForm?.querySelector('button');
//   const markReadBtn = actionMenu.querySelector('.mark_as_Read');
//   const markUnusedBtn = actionMenu.querySelectorAll('.govuk-button')
//     .length > 3 ? actionMenu.querySelectorAll('.govuk-button')[3] : null; // your 4th one
...
//     actionBtn.classList.toggle('govuk-button--disabled', !hasSelection);

//     renameBtn.disabled = !single;
//     renameBtn.classList.toggle('govuk-button--disabled', !single);

//     // All others allow multi-select
//     [discardBtn, markReadBtn, markUnusedBtn].forEach(btn => {
//       if (!btn) return;
//       btn.disabled = !hasSelection;
//       btn.classList.toggle('govuk-button--disabled', !hasSelection);
//     });
//   }

//   checkboxes.forEach(cb => cb.addEventListener('change', updateActionState));
...
//     if (!e.target.closest('.moj-button-menu')) {
...
//       console.log('Renaming material:', selected[0]);
...
//     // Set hidden field to the first or join if needed
//     if (discardForm && selected.length) {
//       discardForm.querySelector('#material_selected').value = selected.join(', ');
//       // You can auto-submit or keep manual submit
//       // discardForm.submit();
//     }
//     actionMenu.style.display = 'none';
//   });
...
//     const selected = getSelected();
//     console.log('Marking as read:', selected);
//     // reuse your mark_as_Read() logic if needed
//     actionMenu.style.display = 'none';
//   });

//   // Mark as unused (multi)
//   if (markUnusedBtn) {
//     markUnusedBtn.addEventListener('click', e => {
//       const selected = getSelected();
//       console.log('Marking as unused:', selected);
